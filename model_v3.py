...
def get_unet():
    ...
    up6 = layers.concatenate([layers.UpSampling2D(size=(2, 2), data_format='channels_last')(conv5), conv4])
    ...
    up7 = layers.concatenate([layers.UpSampling2D(size=(2, 2), data_format='channels_last')(conv6), conv3])
    ...
    up8 = layers.concatenate([layers.UpSampling2D(size=(2, 2), data_format='channels_last')(conv7), conv2])
    ...
    up9 = layers.concatenate([layers.UpSampling2D(size=(2, 2), data_format='channels_last')(conv8), conv1])
